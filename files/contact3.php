...
<li><img src='images/se10salmon.jpg'></li>
    ...
    <!--<li><img src='images/tulip300.jpg'></li>-->
        ...
        <div class="yui-u" style='margin-top:30px;'>
                <h4><span class='nav' title='2011_exhibit' style='color:#cd5106;'>October 2011 exhibit</span></h4>
                <h5 style="margin-top:1em;">"Come in Peep It, or How to Romanticize in the 21st Century"</h5>
                <!--<p style="margin-top:1em;"><span class='nav' title='2011_exhibit'>view show</span></p>-->
